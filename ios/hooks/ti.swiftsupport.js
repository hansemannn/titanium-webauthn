  ...
  cli.on("build.ios.xcodeproject", {
    pre: function (data) {
      ...
      injectSPMPackage(
        ...
        "1.0.0-alpha",
        "WEBAUTHN0101WEBAUTHN01",
        "WEBAUTHN0101WEBAUTHN02",
        "WEBAUTHN0101WEBAUTHN03"
      );
      ...
      Object.keys(xobjs.PBXNativeTarget).forEach(function (targetUuid) {
        ...
        if (target && typeof target === "object") {
          xobjs.XCConfigurationList[
            target.buildConfigurationList
          ].buildConfigurations.forEach(function (buildConf) {
            var buildSettings =
              xobjs.XCBuildConfiguration[buildConf.value].buildSettings;
